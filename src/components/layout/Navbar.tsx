            ...
            <div className="container-narrow flex flex-col gap-1 py-4">
              ...
              >
                <Link
                  href={ctaHref}
                  onClick={() => setOpen(false)}
                  className="mt-3 flex items-center justify-center rounded-md bg-[color:var(--color-primary)] px-4 py-2.5 text-[14px] font-semibold text-[color:var(--color-primary-fg)] transition-colors hover:bg-[color:var(--color-primary-hover)]"
                >
                  Get the app
                </Link>
              </motion.div>

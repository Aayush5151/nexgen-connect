...
export function InsightSection() {
  return (
    <section className="relative overflow-hidden bg-[#0A0A0C] py-20 md:py-32">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#FF6B35]/[0.04] blur-[100px]" />
      <div className="pointer-events-none absolute -left-20 top-20 h-[300px] w-[300px] rounded-full bg-[#FF6B35]/[0.04] blur-[80px]" />
      <div className="pointer-events-none absolute -right-20 bottom-20 h-[300px] w-[300px] rounded-full bg-[#FF6B35]/[0.04] blur-[80px]" />
      ...
      <div className="container-narrow relative text-center">
        ...
        <ScrollReveal delay={0.15} variant="blurIn">
          <blockquote className="mx-auto mt-8 max-w-4xl text-3xl font-black leading-snug text-[#E8E8ED] sm:text-4xl md:text-5xl lg:text-[3.5rem] lg:leading-tight">
            ...
            people{" "}
            <span className="text-[#E8E8ED] italic underline decoration-[#FF6B35]/40 underline-offset-4">
              from your city
            </span>{" "}
          ...
          <div className="mx-auto mt-16 flex items-center justify-center md:mt-20">
            <div className="relative h-72 w-72 sm:h-96 sm:w-96">
              ...
              <motion.div
                ...
                className="group absolute inset-0 rounded-full border border-white/[0.06] transition-all duration-500 hover:border-[#FF6B35]/40"
              >
              ...
              <motion.div
                ...
                className="group absolute inset-[15%] rounded-full border border-white/[0.06] transition-all duration-500 hover:border-[#FF6B35]/40"
              >
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full border border-white/[0.06] bg-[#0A0A0C] px-3 py-0.5 text-[10px] font-semibold tracking-wider text-[#6B7280] sm:text-xs">
                  India &rarr; Country
                </span>
              ...
              <motion.div
                ...
                className="group absolute inset-[30%] rounded-full border-2 border-[#FF6B35]/20 transition-all duration-500 hover:border-[#FF6B35]/40"
              >
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full border border-white/[0.06] bg-[#0A0A0C] px-3 py-0.5 text-[10px] font-semibold tracking-wider text-[#6B7280] sm:text-xs">
                  State &rarr; Country
                </span>
              ...
              <motion.div
                ...
                className="absolute inset-[42%] flex items-center justify-center rounded-full bg-[#FF6B35] shadow-lg shadow-[#FF6B35]/20"
              >

      ...
      <main>
        ...
        <section className="section-padding bg-[#020617]">
          <div className="container-narrow">
            <div className="mx-auto max-w-3xl">
              <ScrollReveal>
                <h2 className="text-3xl font-bold text-[#F8FAFC] sm:text-4xl">Our Mission</h2>
              </ScrollReveal>
              <ScrollReveal delay={0.1}>
        ...
        <section className="section-padding bg-[#020617]">
          <div className="container-narrow">
            <div className="mx-auto max-w-3xl">
              <ScrollReveal>
                <h2 className="text-3xl font-bold text-[#F8FAFC] sm:text-4xl">Our Vision</h2>
              </ScrollReveal>
              <ScrollReveal delay={0.1}>
                <p className="mt-6 text-lg leading-relaxed text-[#94A3B8]">
          ...
          <div className="container-narrow">
            <ScrollReveal>
              <div className="text-center">
                <h2 className="text-3xl font-bold text-[#F8FAFC] sm:text-4xl">What We Stand For</h2>
            ...
            <div className="mx-auto mt-12 grid max-w-4xl gap-6 sm:grid-cols-2">
              {values.map((value, i) => (
                <ScrollReveal key={value.title} delay={i * 0.1}>
                  <div className="group h-full rounded-2xl border border-white/[0.06] bg-[#0F172A] p-6 shadow-none transition-all duration-200 hover:-translate-y-0.5">
                    <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#3B82F6] text-white">
                      <value.icon className="h-6 w-6" />
                    </div>
                    <h3 className="mt-4 text-lg font-semibold text-[#F8FAFC]">{value.title}</h3>

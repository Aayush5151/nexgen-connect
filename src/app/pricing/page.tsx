        ...
        <section className="section-padding bg-[#0A0A0C]">
          <div className="container-narrow">
            <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2">
              ...
              <ScrollReveal>
                <div className="flex h-full flex-col rounded-2xl border border-white/[0.06] bg-[#141416] p-8 shadow-none">
                  ...
                  <LinkButton
                    href="#download"
                    variant="outline"
                    className="mt-8 w-full rounded-lg border-[#2A2A2E] py-3 text-[#9CA3AF] hover:text-[#E8E8ED] hover:border-[#FF6B35]/30"
                  >
              ...
              {/* Unlock */}
              <ScrollReveal delay={0.1}>
                <div className="relative flex h-full flex-col rounded-2xl border-2 border-[#FF6B35]/30 bg-[#141416] p-8 shadow-none">
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-[#FF6B35] px-5 py-1 text-xs font-semibold text-white">
                    Most Popular
                  </div>
                  ...
                  <ul className="mt-8 flex-1 space-y-4">
                    {unlockFeatures.map((f) => (
                      <li key={f} className="flex items-start gap-3 text-sm text-[#D1D5DB]">
                        <Check className="mt-0.5 h-4 w-4 shrink-0 rounded-full bg-[#FF6B35]/10 text-[#FF6B35]" />
                        {f}
                      </li>
                    ))}
                  </ul>
                  ...
                  <LinkButton
                    href="#download"
                    className="mt-8 w-full rounded-lg bg-[#FF6B35] py-3 text-white hover:bg-[#E85D2F] active:scale-[0.98]"
                  >
                    Download & Unlock
                  </LinkButton>
                </div>

...
export const metadata: Metadata = {
  title: "Press",
  description:
    "Press kit for NexGen Connect. Logo, boilerplate, founder bio, and press contact. Ireland first. Everywhere after that.",
};
...
const QUICK_FACTS = [
  ...
  { label: "First corridor", value: "India → Ireland" },
  { label: "App launches", value: "September 2026" },
  { label: "Platforms", value: "iOS · Android" },
];

const BOILERPLATE_EN = `NexGen Connect is a mobile app that forms a pocket-sized group of eight to twelve verified students flying to the same country, in the same month. Every member is verified through three checks: phone OTP via MSG91, Aadhaar consent via DigiLocker (a one-way verification token - the Aadhaar number itself is never stored), and a human-reviewed admit letter. Group DMs unlock only once a corridor crosses sixty verified students. The first corridor ships in September 2026 and connects Indian students headed to University College Dublin, Trinity College Dublin, and University College Cork. NexGen Connect is students-only, with a free tier that covers matching, verification, and group DMs, and a one-time Premium unlock at rupees 1,499 that adds priority matching four months before intake, group-apply apartment tooling (a shared shortlist from our student-housing partners, lease-readiness checklists, co-signer coordination, and the Alumni Handover Board), and a read-only Parent view with priority 24/7 support. No immigration agents. No recruiters. No ads. No subscription.`;

const BOILERPLATE_SHORT = `NexGen Connect is a verified, students-only mobile app that forms a pocket-sized group of eight to twelve classmates flying the same corridor, before they land. Free to use. Premium one-time unlock for priority matching, apartment coordination, and parent peace of mind. Launching September 2026 with India - Ireland.`;

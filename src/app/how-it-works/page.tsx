    ...
    <>
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-[#0A0A0C] py-20 md:py-28">
          <div className="pointer-events-none absolute -right-32 -top-32 h-96 w-96 rounded-full bg-[#FF6B35]/[0.04] blur-3xl" />
                ...
                <ScrollReveal key={step.title} delay={0.05}>
                  <div className="flex flex-col gap-6 sm:flex-row sm:gap-8">
                    ...
                    <div className="flex shrink-0 items-start gap-4 sm:flex-col sm:items-center">
                      <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#FF6B35] to-[#FF8F65] text-white shadow-none">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-3">
                        <h3 className="text-xl font-bold text-[#E8E8ED] sm:text-2xl">{step.title}</h3>
                        <span className="rounded-full bg-[#141416] border border-white/[0.06] px-3 py-0.5 text-xs font-medium text-[#9CA3AF]">
                          {step.time}
                        </span>
                      </div>
                      <p className="mt-2 text-[#9CA3AF]">{step.description}</p>
                      <ul className="mt-4 space-y-2">
                        {step.details.map((detail) => (
                          ...
                          >
                            <ArrowRight className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#FF6B35]" />
                            {detail}
                          </li>
                        ))}
                      </ul>
        ...
        <section className="section-padding bg-[#141416]/40">
          <div className="container-narrow">
            ...
            <ScrollReveal delay={0.1}>
              <div className="mx-auto mt-10 max-w-2xl overflow-hidden rounded-2xl border border-white/[0.06] bg-[#141416] shadow-none">
                <div className="grid grid-cols-3 border-b border-white/[0.06] bg-[#141416] px-4 py-3 text-center text-sm font-semibold">
                  <span className="text-left text-[#9CA3AF]">Feature</span>
                  <span className="text-[#E8E8ED]">Free</span>
                  <span className="text-[#E8E8ED]">Unlocked</span>
                </div>
                {freeVsPaid.map((row) => (
                  <div
                    key={row.feature}
                  ...
                  >
                    <span className="text-left text-[#E8E8ED]">{row.feature}</span>
                    <span className="text-[#E8E8ED]">{row.free ? "\u2713" : <span className="text-[#6B7280]">{"\u2014"}</span>}</span>
                    <span className="text-[#E8E8ED]">{row.paid ? "\u2713" : <span className="text-[#6B7280]">{"\u2014"}</span>}</span>
                  </div>
                ))}
              </div>
            </ScrollReveal>
        ...
        {/* CTA */}
        <section className="section-padding bg-[#141416] text-center">
          <div className="container-narrow">
            <ScrollReveal>
              <h2 className="text-3xl font-bold text-[#E8E8ED] sm:text-4xl">Ready to Find Your People?</h2>
              <p className="mx-auto mt-3 max-w-xl text-[#9CA3AF]">
            ...
            <ScrollReveal delay={0.15}>
              <LinkButton
                href="#download"
                className="btn-shimmer mt-8 h-14 rounded-xl bg-[#FF6B35] px-8 text-base font-semibold text-white shadow-none hover:bg-[#E85D2F] active:scale-[0.98]"
              >
                Download the App
              </LinkButton>
            </ScrollReveal>

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    // for the corpus. Alternates cover the destination markets (en_IE for
    // Ireland Sept 2026, en_DE for Germany Oct 2026 audiences who land
    // here in English) and the generic en_US fallback so OG validators
    // outside India still treat the URL as a first-class English page.
    locale: "en_IN",
    alternateLocale: ["en_IE", "en_DE", "en_US"],
    url: SITE_URL,
  },
  twitter: {

...
const SAFETY = [
  ...
  },
  {
    ...
    body: "The government consent flow hands us a one-way verification token. We never receive, store, or log the Aadhaar number itself - the scariest number in your wallet never touches our servers. If DigiLocker cannot reach you (Aadhaar not yet linked, mobile number recently changed, account deactivated), the admit-letter human review path covers the gap with a held spot.",
  },
  {
  ...
  },
  {
    ...
    body: "Tap report and an in-house Trust and Safety advisor, a real named human, first-responds within 4 hours during IST business hours (12 hours overnight, 1 hour for Premium 24/7). Imminent-harm cases get a 30-minute outreach attempt, any time of day. Identity-tied bans mean a removed user cannot sock-puppet back with a new phone number, a new email, or a re-issued Aadhaar VID - the ban is anchored on a stable composite.",
  },
];
      ...
      <main id="main" className="flex-1">
        ...
        <section className="section-y border-t border-[color:var(--color-border)]">
          <div className="container-narrow text-center">
            ...
            >
              Forty-eight hours to verify you.{" "}
              <span className="font-serif font-normal italic tracking-[-0.02em] text-[color:var(--color-fg-muted)]">
                Then we wait until your corridor is real.
              </span>
            </h2>
            <p className="mx-auto mt-6 max-w-[620px] text-[16px] leading-[1.55] text-[color:var(--color-fg-muted)]">
              Phone in seconds. DigiLocker in minutes. Admit letter
              human-reviewed inside 48 hours. From there we hold your seat
              until 60 verified students share your home city, your
              destination, and your intake month - that&rsquo;s when the
              corridor unlocks and the group DMs open. We never tell you
              the corridor is &ldquo;active&rdquo; before it actually is.
            </p>

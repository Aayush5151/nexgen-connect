...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    duration: "2 min",
    body: "Government consent flow. We only receive a verification token - never the Aadhaar number itself. If DigiLocker cannot reach you (Aadhaar not yet linked, mobile recently changed, account deactivated), our admit-letter human review covers the gap with a held spot.",
  },
  {
    idx: "03",
    icon: FileCheck,
    title: "Admit letter",
    duration: "Within 48h",
    body: "A real human reviews your admit PDF, every Irish HEI (the 7 universities, 5 TUs, RCSI, plus HECA private colleges) or every German HEI (TU9, LMU, FU, plus most UAS). No bots, never auto-approve.",
  },
];

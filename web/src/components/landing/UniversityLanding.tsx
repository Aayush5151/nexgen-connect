      ...
      <main id="main" className="flex-1">
        ...
        <section className="border-y border-[color:var(--color-border)] bg-[color:var(--color-surface)] py-8 md:py-10">
          <div className="container-narrow">
            ...
            {/* Sourcing footnote. Per-uni Indian-student counts are
                triangulated estimates, not exact head-counts; this footnote
                makes that explicit so the strip reads as honest
                directional, not as published HEA/DAAD figures. */}
            <p className="mt-4 font-mono text-[10px] uppercase tracking-[0.1em] text-[color:var(--color-fg-subtle)] sm:text-[11px]">
              Per-university counts are founder-triangulated estimates from HEA
              (Ireland) and DAAD/DZHW (Germany) baselines + Indian Embassy
              registrations + admissions-office check-ins. Treat as
        ...
        <section className="relative border-t border-[color:var(--color-border)] bg-[color:var(--color-bg)] py-12 md:py-16">
          <div className="container-narrow">
            <div className="mx-auto max-w-[720px] text-center">
              ...
              {/* Provenance footnote. Quotes come from the pre-launch pilot
                  survey of Indian students bound for Ireland and Germany
                  (n=214, Nov 2025 – Feb 2026). Names abbreviated for
                  privacy at the respondent's request. Not paid testimonials. */}
              <p className="mx-auto mt-3 max-w-[480px] text-[11.5px] leading-[1.5] text-[color:var(--color-fg-subtle)]">
                Source: NexGen Connect pre-launch pilot survey, n=214 Indian
                students bound for Ireland or Germany (Nov 2025 – Feb 2026).
                Names abbreviated at respondent request. No payment, no
                solicitation.
              </p>
            </div>
          </div>
